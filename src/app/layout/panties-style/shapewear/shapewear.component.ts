...
export class ShapewearComponent implements OnInit {
    ...
    images:{ [key: string]: string } = {
        '#d43743': 'assets/images/product/shapewear-3.webp',
        '#d6a583': 'assets/images/product/shapewear-1.webp',
        '#e8e5e9': 'assets/images/product/shapewear-4.webp',
        '#030509': 'assets/images/product/shapewear-2.webp'
    };
     noWrapSlides = false;
     showIndicator = true;
