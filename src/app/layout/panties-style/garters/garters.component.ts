...
export class GartersComponent implements OnInit {
    ...
    images:{ [key: string]: string } = {
        '#d43743': 'assets/images/product/garters-1.webp',
        '#d6a583': 'assets/images/product/garters-2.webp',
        '#e8e5e9': 'assets/images/product/garters-1.webp',
        '#030509': 'assets/images/product/garters-2.webp'
    };
     noWrapSlides = false;
     showIndicator = true;
