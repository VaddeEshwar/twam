...
@Component({
    selector: 'app-high-waist',
    templateUrl: './high-waist.component.html',
    styleUrls: ['./high-waist.component.scss'],
    // animations: [routerTransition()]
})
export class HighwaistComponent implements OnInit {
    ...
    images:{ [key: string]: string } = {
        '#d43743': 'assets/images/product/high-waist-3.webp',
        '#d6a583': 'assets/images/product/high-waist-1.webp',
        '#e8e5e9': 'assets/images/product/high-waist-4.webp',
        '#030509': 'assets/images/product/high-waist-2.webp'
    };
     noWrapSlides = false;
     showIndicator = true;
