...
export class LightlylinedbrasComponent implements OnInit {
    ...
    images:{ [key: string]: string } = {
        '#d43743': 'assets/Product/Amante/Bras/MinimizerBra/NonPadded/001.webp',
        '#d6a583': 'assets/Product/Amante/Bras/MinimizerBra/NonPadded/002.webp',
        '#e8e5e9': 'assets/Product/Amante/Bras/MinimizerBra/NonPadded/003.webp',
        '#030509': 'assets/Product/Amante/Bras/MinimizerBra/NonPadded/004.webp'
    };
     noWrapSlides = false;
     showIndicator = true;
